...
type TrackClient interface {
	CreateTrack(ctx context.Context, in *TrackDescription, opts ...grpc.CallOption) (*Empty, error)
...
func (c *trackClient) CreateTrack(ctx context.Context, in *TrackDescription, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *trackClient) GetRegisteredTracks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TracksDescriptions, error) {
	out := new(TracksDescriptions)
...
type TrackServer interface {
	CreateTrack(context.Context, *TrackDescription) (*Empty, error)
...
func (UnimplementedTrackServer) CreateTrack(context.Context, *TrackDescription) (*Empty, error) {
...
func (UnimplementedTrackServer) GetRegisteredTracks(context.Context, *Empty) (*TracksDescriptions, error) {
